...
class TestRouteAfterRouting:
    ...
    def test_route_complex_strategy_to_decomposition(self):
        """Test complex strategy routes to decomposition (US-10.4.3)."""
    ...
    def test_route_simple_with_sub_questions_to_retrieval(self):
        """Test simple strategy with sub_questions still routes to retrieval.

        Note: sub_questions don't affect routing - strategy determines the path.
        """
