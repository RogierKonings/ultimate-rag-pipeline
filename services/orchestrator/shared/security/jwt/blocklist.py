...
class RedisTokenBlocklist(TokenBlocklist):
    ...
    Example:
        ...
        from shared.security.jwt import RedisTokenBlocklist, JWTHandler
...
class AsyncRedisTokenBlocklist(TokenBlocklist):
    ...
    Example:
        ```python
        from redis.asyncio import Redis
        from shared.security.jwt import AsyncRedisTokenBlocklist
...
class InMemoryTokenBlocklist(TokenBlocklist):
    ...
    Example:
        ```python
        from shared.security.jwt import InMemoryTokenBlocklist, JWTHandler
