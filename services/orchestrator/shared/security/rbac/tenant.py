...
class TenantContext:
    ...
    Example:
        ```python
        from shared.security.rbac import TenantContext, get_current_tenant
...
class TenantContextManager:
    ...
    Usage:
        ```python
        from shared.security.rbac import TenantContextManager
...
class TenantMiddleware:
    ...
    Usage:
        ...
        from shared.security.rbac import TenantMiddleware
