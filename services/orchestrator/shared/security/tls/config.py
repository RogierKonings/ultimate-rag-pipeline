...
def create_server_ssl_context(
    ...
    Example:
        ```python
        from shared.security.tls import create_server_ssl_context
...
def create_client_ssl_context(
    ...
    Example:
        ```python
        import httpx
        from shared.security.tls import create_client_ssl_context
...
def create_postgres_ssl_context(
    ...
    Example:
        ```python
        from shared.security.tls import create_postgres_ssl_context
...
def create_redis_ssl_context(
    ...
    Example:
        ...
        from shared.security.tls import create_redis_ssl_context
