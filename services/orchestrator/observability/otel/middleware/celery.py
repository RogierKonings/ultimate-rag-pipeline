...
def instrument_celery(
    ...
    Example:
        ...
        from orchestrator.observability.otel.middleware import instrument_celery
...
def get_task_trace_headers() -> dict[str, Any]:
    ...
    Example:
        from orchestrator.observability.otel.middleware.celery import get_task_trace_headers
