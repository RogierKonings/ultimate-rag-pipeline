...
class TestPostgresSSL:
    ...
    def test_creates_ssl_context_verify_full(self):
        ...
        with patch("pathlib.Path.exists", return_value=True):
            from services.shared.database.connection import create_ssl_context
    ...
    def test_get_database_url_without_password(self):
        ...
        from services.shared.database.connection import get_database_url_without_password
...
class TestRedisTLS:
    ...
    def test_creates_tls_context_production(self):
        ...
        with patch("pathlib.Path.exists", return_value=False):
            from services.shared.cache.redis_client import get_ssl_context
...
class TestOpenSearchSSL:
    ...
    def test_creates_ssl_context_production(self):
        ...
        from services.shared.search.opensearch_client import OpenSearchClient
    ...
    def test_loads_client_certificate_for_mtls(self):
        ...
        with (
            ...
            from services.shared.search.opensearch_client import (
                OpenSearchClient,
            )
...
class TestLogSanitizer:
    ...
    def test_sanitizes_password_in_url(self):
        ...
        from services.shared.observability.logging.sanitizer import sanitize_value
    ...
    def test_sanitizes_sensitive_dict_keys(self):
        ...
        from services.shared.observability.logging.sanitizer import sanitize_dict
    ...
    def test_sanitize_connection_string(self):
        ...
        from services.shared.observability.logging.sanitizer import (
    ...
    def test_structlog_processor(self):
        ...
        from services.shared.observability.logging.sanitizer import SanitizingProcessor
...
class TestSensitiveDataFilter:
    ...
    def test_masks_jwt_tokens(self):
        ...
        from services.shared.observability.logging.filters import SensitiveDataFilter
