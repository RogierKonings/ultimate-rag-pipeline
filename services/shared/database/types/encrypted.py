...
def configure_encryption(encryption_instance) -> None:
    ...
    Example:
        ```python
        from services.shared.security.encryption import FieldEncryption
        from services.shared.database.types import configure_encryption
...
class EncryptedString(TypeDecorator):
    ...
    Example:
        ...
        from services.shared.database.types import EncryptedString
...
class EncryptedJSON(TypeDecorator):
    ...
    Example:
        ```python
        from sqlalchemy import Column
        from services.shared.database.types import EncryptedJSON
