...
class APIConnectorConfig(BaseModel):
    ...
    basic_username: Optional[str] = Field(
        default=None,
        description="Username for basic authentication"
    )
    basic_password: Optional[str] = Field(
        default=None,
    ...
    total_json_path: Optional[str] = Field(
        default="$.total",
...
class APIConnector(BaseConnector):
    ...
    def _extract_next_cursor(self, data: dict[str, Any]) -> Optional[str]:
    ...
    def _extract_total(self, data: dict[str, Any]) -> Optional[int]:
