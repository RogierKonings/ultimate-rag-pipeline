...
- [x] `scripts/dev-ingest.py` - CLI for ingestion API
- [x] `scripts/dev-query.py` - CLI for orchestrator queries with debug output
- [x] `scripts/dev-health.py` - Check all service health endpoints
- [x] `scripts/dev-reconcile.py` - Trigger index reconciliation
...
- [x] All CLI tools implemented
- [x] Tools documented in README
- [x] Installable as dev dependencies (httpx, rich)
- [ ] Code reviewed
